...
public class adapter_main extends FirebaseRecyclerAdapter<product_add_view_helperclass,adapter_main.myviewholder> {

    public adapter_main(@NonNull FirebaseRecyclerOptions<product_add_view_helperclass> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull myviewholder myviewholder, int i, @NonNull product_add_view_helperclass product_add_view_helperclass) {
        ...
        myviewholder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(v.getContext(), "Login For Details ", Toast.LENGTH_SHORT).show();
